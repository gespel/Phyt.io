...
String StensMoistureSensor::getHTML() {
  String p = this->eberhardt_jr->getName() + ":<br>Bodenfeuchtigkeit: " + this->eberhardt_jr->getHumidity() + " %<br><br>";
  String p2 = this->pfefferminze->getName() + ":<br>Bodenfeuchtigkeit: " + this->pfefferminze->getHumidity() + " %<br><br>";
  String p3 = this->brutblatt->getName() + ":<br>Bodenfeuchtigkeit: " + this->brutblatt->getHumidity() + " %<br><br>";
  return p + p2 + p3;
}
